...
import image from "../../../assets/img/page/choose-us.jpg.webp";
                    ...
                    <div className="row al-center">
                        <div className="col-xl-6 col-lg-5 lg-mb-25">
                            <div className="choose__three-left t-right mr-60 xl-mr-0">
                                <img className="lg_img_full wow img_left_animation" src={image} alt="image" />
                            </div>
                        </div>
                        <div className="col-xl-6 col-lg-7">
                            <div className="choose__three-right">
                                ...
                                <div className="wow fadeInDown" data-wow-delay="1.2s">
                                    <Link className="build_button" to="/contact-us">Started Today<i className="flaticon-right-up"></i></Link>
                                </div>
                            </div>
                        </div>
                    </div>

...
const HeaderThree = () => {
    ...
    return (
        <>
            <div className={`header__area three ${isSticky ? 'header__sticky-sticky-menu' : ''}`}>
                    ...
                    <div className="header__area-menubar">
                        ...
                        <div className="header__area-menubar-right">
                            ...
                            <div className="header__area-menubar-right-btn">
                                <Link className="build_button" to="/request-quote">Get Started<i className="flaticon-right-up"></i></Link>
                            </div>

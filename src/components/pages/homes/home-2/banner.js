			...
			<div className="banner__two">
				...
				<SwiperSlide>
					<div className="banner__two-area">	
						<div className="banner__two-area-image" style={{backgroundImage: `url(${banner1})`}}></div>
				...
				<SwiperSlide>
					<div className="banner__two-area">	
						<div className="banner__two-area-image" style={{backgroundImage: `url(${banner2})`}}></div>
						<div className="container">
							<div className="row align-items-center">
								<div className="col-xl-12">
									<div className="banner__two-content">
				...
				<SwiperSlide>
					<div className="banner__two-area">	
						<div className="banner__two-area-image" style={{backgroundImage: `url(${banner3})`}}></div>
						<div className="container">
							<div className="row align-items-center">
								<div className="col-xl-12">
									<div className="banner__two-content">
